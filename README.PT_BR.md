...
- O tooling Python de baseline está descrito em [`tools/python_baseline/README.md`](tools/python_baseline/README.md).
...
O código e a documentação deste repositório estão sob Apache 2.0. Veja [LICENSE](LICENSE).
